                        ...
                        $scope.view = {
                            ...
                            position: function () {
                                if (!$scope.view.isOpen || $scope.position || $scope.inline)
                                    return;
                                var element = $element[0], picker = $scope.picker.children()[0],
                                    ...
                                    left = offset.left - _this.$window.pageXOffset, winWidth = _this.$window.innerWidth,
                                    ...
                                    pickerLeft = offset.left + 'px', pickerWidth = element.offsetWidth + 'px';
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        var HourView = (function () {
            ...
            HourView.prototype.render = function () {
                var i = 0, minute = this.$scope.view.moment.clone().startOf('hour').minute(this.provider.minutesStart),
        ...
        var MonthView = (function () {
            ...
            MonthView.prototype.render = function () {
                ...
                var month = this.$scope.view.moment.month(),
                    day = this.$scope.view.moment.clone().startOf('month').startOf('week').hour(12), rows = {},
                    firstWeek = day.week(), lastWeek = firstWeek + 5;
                this.rows = [];
